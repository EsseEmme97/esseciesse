						...
						<div class="row gx-0">
							<div class="col-lg-6 d-flex align-items-end">
								<div class="p-10 p-md-11 p-lg-14">
									<p class="lead text-inverse fs-17 lh-base">  
										<i class="uil uil-calendar-alt"></i>&nbsp;<?=$data?>
									</p>									
									<h2 class="display-4 text-white mb-5"><?=$titolo?></h2>
									<p class="lead text-inverse fs-17 mb-7 lh-base">  
										<?=$desb?>
									</p>
									<a href="<?=$pathindex.$path[$lingua]."/".CleanString($titolo)?>" class="btn text-white btn-primary fs-17 fw-bold rounded mt-2 mb-4"><?=$lanmore[$lingua]?> <i class="uil uil-arrow-right"></i></a>
								</div>
							</div>
							<!--/column -->
<?
