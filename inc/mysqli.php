...
define( 'DB_HOST', 'localhost' ); // set database host
define( 'DB_USER', 'root' ); // set database user
define( 'DB_PASS', 'carbon123' ); // set database password
define( 'DB_NAME', 'pizeta' ); // set database name
...
class DB
{
    ...
    */
    ...
    /**
     * Get number of effected rows after a query
     *
     * Example usage:
     * $database->update( 'users_table', $user );
     * $last = $database->affected_rows();
     *
     * @access public
     * @param none
     * @return int
